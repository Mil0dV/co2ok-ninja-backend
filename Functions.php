<?php
	...
	function readArraySite($url){
		...
		$DaisyCon = array("drogisterij", "happyhome", "123tijdschrift", "manymorestores", "lacasita", "nationaletijdschriftenbon", "knuffelparadijs", "ritel", "ponyparkcity", "opvakantievanafeindhoven", "opvakantievanafrotterdam", "opvakantievanafeelde", "parship", "cardelmar", "nl.gay-parship", "golfreizen.nu", "maxivillas", "simpel", "newfigure", "suntip", "trendy-hotels", "jambo", "office-deals", "freshlabelz", "tennisdirect", "voetbaldirect", "eugrowshop.eu", "bikesplaza", "oranje-artikelen-winkel", "eenvakantiehuisje", "vakantieveluwe", "verkleedkledingwinkel", "funenfeestwinkel", "partyshopper.be", "BeleefAmerika", "zoweg", "de-speelgoedwinkel", "feestpruikenwinkel", "hotels", "golftest", "5cc", "subsidesports", "no-ice", "brandsupply", "worldwidecampers", "topsnowshop", "iparts4u", "succubus", "vanoutlet", "meditel", "123wonen", "robinmobile", "yoursminc", "hipinderegen", "dagtickets", "kekkekids", "carldenig", "vergelijkers.daisycon", "iparkingschiphol.eu", "fotodevakman", "flapoorstickers", "nl.aliexpress", "dx", "sandalenshop", "zorgthuiswinkel", "usedpc4sale", "goedkoopste-kantoorartikelen", "webshopvoorhonden", "webshopvoorkatten", "trk.thinkaction", "mysurvey", "globaltestmarket", "rec-eu.i-say", "opinieland", "laptops4all", "sportiek", "licentie2go", "huisdierzaak", "6deals", "samsam.samr", "woononline", "shopndrop", "geeektech", "websa", "sierbetononline", "toysforjoy", "remarkt", "abcarrental", "drogisterijplus", "kesvisum", "shop4nl", "comforttrends", "gezondmarkt", "pranayur", "sniztop", "sloffen-specialist", "autovendi", "denksport", "gsmsale", "panelclix", "grotekadoshop", "cruisereizen", "ockyz", "floowtravel", "estivant", "kinq", "bungalow", "dierplagenshop", "spaonline", "kantoormeubelenplus", "vitamineman", "ditverzinjeniet", "ditverzinjeniet.be", "kidsgigant", "mobieltekoop", "timefortrends", "hbcare", "autobench", "puppyren", "verrekijkerdirect", "reisbench", "gratisuitgifte", "erovibes", "home8-alarm", "epine", "hoiveluwe", "msfinanciallease", "co88collection", "vitaminecompleet", "droomidee", "avs4you", "meubis.be", "vanarendonk", "mycooks", "holidaysuites.be", "legalparrot", "bungalows", "fietsparadijs", "shoefresh.eu", "eindelijkglasvezel", "duosleep", "booqees", "play-start", "maxenluna", "slagbijchatham", "startselect", "kompashosting", "vergelijkers.daisycon", "greenwatch", "zaful", "volumerate", "jakosportkleding", "maascomputers", "vavaonderzoek", "goedgemerkt", "designonline24.be", "acculaders", "fietstas", "albeka", "well-fair", "antrekk", "secretrooms", "topoutdoorshop", "gfkpanel", "icocryptex.io", "bold-banana", "jiggy", "monteuraanhuis", "goodiebox", "contentmods", "goedkoopste-kantoormeubilair", "mobrog", "hempworx", "allyouplay", "verisure", "birdwise");
